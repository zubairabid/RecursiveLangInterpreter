...
var $author$project$Main$inorder = function (tree) {
	if (tree.$ === 'Leaf') {
		var val = tree.a;
		return _List_fromArray(
			[val]);
		...
		return A2(
			...
			$author$project$Main$inorder(left),
			A2(
				$elm$core$List$append,
				_List_fromArray(
					[val]),
	...
	_List_fromArray(
		[
			...
			function (_v0) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$author$project$Main$inorder($author$project$SampleTests$singleton_tree),
					_List_fromArray(
						[10]));
			}),
			A2(
			...
			function (_v1) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$author$project$Main$inorder($author$project$SampleTests$regular_tree),
					_List_fromArray(
						[5, 200, 6, 50, 80, 100, 40]));
			})
		]));
var $author$project$Main$tree_insert = F4(
	function (path, lst, rst, tree) {
		if (!path.b) {
			if (tree.$ === 'Leaf') {
				var v = tree.a;
				return A3($author$project$Defns$Node, v, lst, rst);
			} else {
				var v = tree.a;
				var left = tree.b;
				var right = tree.c;
				return A3($author$project$Defns$Node, v, left, right);
			}
		} else {
			var first = path.a;
			var rest = path.b;
			if (first.$ === 'Left') {
				if (tree.$ === 'Leaf') {
					var v = tree.a;
					return $author$project$Defns$Leaf(v);
				} else {
					var v = tree.a;
					var left = tree.b;
					var right = tree.c;
					return A3(
						$author$project$Defns$Node,
						v,
						A4($author$project$Main$tree_insert, rest, lst, rst, left),
						right);
				}
			} else {
				if (tree.$ === 'Leaf') {
					...
					return A3(
						...
						v,
						left,
						A4($author$project$Main$tree_insert, rest, lst, rst, right));
				}
			}
		}
	});
var $author$project$SampleTests$test_insert = A2(
	$elm_explorations$test$Test$describe,
	'Insert',
	_List_fromArray(
		[
			...
			function (_v0) {
				return A2(
					$elm_explorations$test$Expect$equal,
					A4(
						$author$project$Main$tree_insert,
						_List_Nil,
						$author$project$Defns$Leaf(3),
						$author$project$Defns$Leaf(5),
		...
		if (!loi1.b) {
			...
			if (!loi2.b) {
				...
				return (_Utils_cmp(x, y) < 0) ? A2(
					$elm$core$List$cons,
					x,
					A2($author$project$Main$merge, xs, loi2)) : A2(
					$elm$core$List$cons,
					y,
					A2($author$project$Main$merge, loi1, ys));
			}
		}
	});
var $author$project$SampleTests$test_merge = A2(
	$elm_explorations$test$Test$describe,
	'Merge',
	_List_fromArray(
		[
...
var $author$project$Main$postorder = function (tree) {
	if (tree.$ === 'Leaf') {
		var val = tree.a;
		return _List_fromArray(
			[val]);
		...
		return A2(
			$elm$core$List$append,
			$author$project$Main$postorder(left),
			A2(
				$elm$core$List$append,
				$author$project$Main$postorder(right),
				_List_fromArray(
					[val])));
	}
};
var $author$project$SampleTests$test_postorder = A2(
	$elm_explorations$test$Test$describe,
	'Postorder',
	_List_fromArray(
		[
			...
			function (_v0) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$author$project$Main$postorder($author$project$SampleTests$singleton_tree),
					_List_fromArray(
						[10]));
			}),
			A2(
			...
			function (_v1) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$author$project$Main$postorder($author$project$SampleTests$regular_tree),
					_List_fromArray(
...
var $author$project$Defns$Left = {$: 'Left'};
var $author$project$Defns$Right = {$: 'Right'};
var $author$project$Main$search = F2(
	function (val, tree) {
		if (tree.$ === 'Leaf') {
			var v = tree.a;
			return _Utils_eq(v, val) ? $elm$core$Maybe$Just(_List_Nil) : $elm$core$Maybe$Nothing;
		} else {
			var v = tree.a;
			var left = tree.b;
			var right = tree.c;
			if (_Utils_eq(v, val)) {
				...
				var lefts = A2($author$project$Main$search, val, left);
				if (lefts.$ === 'Nothing') {
					var rights = A2($author$project$Main$search, val, right);
					if (rights.$ === 'Nothing') {
						return $elm$core$Maybe$Nothing;
					} else {
						return $elm$core$Maybe$Just(
							A2(
								$elm$core$List$cons,
								$author$project$Defns$Right,
								A2($elm$core$Maybe$withDefault, _List_Nil, rights)));
					}
				} else {
					return $elm$core$Maybe$Just(
						A2(
							$elm$core$List$cons,
							$author$project$Defns$Left,
							A2($elm$core$Maybe$withDefault, _List_Nil, lefts)));
				}
			}
		}
	});
var $author$project$SampleTests$test_search = A2(
	$elm_explorations$test$Test$describe,
	'Search',
	_List_fromArray(
		[
			...
			function (_v0) {
				return A2(
					$elm_explorations$test$Expect$equal,
					A2($author$project$Main$search, 200, $author$project$SampleTests$regular_tree),
					$elm$core$Maybe$Just(
						_List_fromArray(
							[$author$project$Defns$Left, $author$project$Defns$Left])));
			})
		]));
			...
			if (first.$ === 'Left') {
				if (tree.$ === 'Leaf') {
					...
					return A3(
						$author$project$Defns$Node,
						v,
						A3($author$project$Main$update, rest, fn, left),
						right);
				}
			} else {
				if (tree.$ === 'Leaf') {
					...
					return A3(
						...
						v,
						left,
						A3($author$project$Main$update, rest, fn, right));
				}
			}
		}
	});
var $author$project$SampleTests$test_update = A2(
	$elm_explorations$test$Test$describe,
	'Update',
	_List_fromArray(
		[
			...
			function (_v0) {
				return A2(
					...
					A3(
						...
						$author$project$SampleTests$singleton_tree),
					$author$project$Defns$Leaf(10));
			})
		]));
var $author$project$Main$value_at_path = F2(
	function (path, tree) {
		value_at_path:
		while (true) {
			if (!path.b) {
...
var $author$project$SampleTests$test_value_at_path = A2(
	$elm_explorations$test$Test$describe,
	'Value at Path',
	_List_fromArray(
		[
			...
			function (_v0) {
				return A2(
					$elm_explorations$test$Expect$equal,
					A2(
						$author$project$Main$value_at_path,
						_List_fromArray(
							[$author$project$Defns$Left, $author$project$Defns$Right]),
						$author$project$SampleTests$regular_tree),
			...
			function (_v1) {
				return A2(
					$elm_explorations$test$Expect$equal,
					A2($author$project$Main$value_at_path, _List_Nil, $author$project$SampleTests$regular_tree),
